...
class Sorted_List:
    ...
    def clean(self):
        ...
        -------------------------------------------------------
        """
        # Your code here #from List_array clean()
    ...
    def count(self, key):
        ...
        number = 0
        while x < length:
            if key in self._values[x:length-1]:
                number += 1
            x += 1
        return number
    ...
    def remove_many(self, key):
        ...
        length = len(self._values)
        x = self._binary_search(key)
        start = self._binary_search(key)
        end = self._binary_search(key)
        while x < length:
            if key in self._values[end:]:
                end += 1
            x += 1
        #print(start, end)
        # print(self._values[start:end])
        # if end == length-1:
    ...
    def split_key(self, key):
        ...
        i = 0
        while i < len(self._values):
            if deepcopy(self._values[i]) < key:
                target1._values.append(deepcopy(self._values[i]))
            else:
                target2._values.append(deepcopy(self._values[i]))
            i += 1
