    ...
    def gnome_sort(a):
        ...
        if len(a) > 0:
            ...
            while curr is not None:
                ...
                if curr == a._front:  # only for first case,
                    curr = curr._next

                elif curr != a._front:
                    if curr._prev._value <= curr._value:  # pots in order
                        curr = curr._next  # move right, no swap

                    elif curr._prev._value > curr._value:  # pots not in order
                        a._swap(curr._prev, curr)  # swap
        return
